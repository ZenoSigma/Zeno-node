...
| :--- | :--- | :--- |
| **Node Registration** | `__init__.py`, `nodes/__init__.py` | Exports `NODE_CLASS_MAPPINGS` and `NODE_DISPLAY_NAME_MAPPINGS` to ComfyUI node registry. |
...
| **Verification & Tests** | `tests/test_naming.py` | Unittest suite verifying graph inspection, sanitization regex, prefix construction, and casing normalization. |

---

## 3. 🔄 Data Pipelines

### A. Latent & Image Transformation Pipeline
...
### B. Image Saving & Metadata Pipeline
